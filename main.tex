...
\begin{itemize}[label=\color{Mahogany}\faChevronRight]
    \item \spoon \textbf{PL} = polévková lžíce
    \item \tsp \textbf{KL} = kávová lžička
\end{itemize}
\vspace{1cm}
...
\begin{recipe}[Teal]{Rybí pomazánka (Jižňácká)}
    \begin{ingredients}
        \item \weight \textbf{250 g} \\ Másla
        \item \piece \textbf{3 ks} \\ Sardinek (žlutý obal)
        \item \piece \textbf{1 ks} \\ Sardinek (s feferonkou)
        \item \piece \textbf{4 ks} \\ Sladkokyselé okurky
        \item \piece \textbf{1 ks} \\ Cibule
        \item \indefinite \textbf{špetka} \\ Sladké papriky, sůl, pepř
    \end{ingredients}
    \begin{steps}
        \item Máslo vyšleháme šlehačem do pěny.
        \item Přidáme rybičky (i s trochou oleje) a dál šleháme.
        \item Dochutíme paprikou, solí a pepřem.
        \item Nakonec vmícháme nadrobno nakrájenou cibuli a okurky.
    \end{steps}
\end{recipe}

\begin{recipe}[JungleGreen]{Celerová pomazánka}
    \begin{ingredients}
        \item \piece \textbf{1/4 ks} \\ Celeru (střední)
        \item \piece \textbf{1 ks} \\ Jablko
        \item \piece \textbf{3 ks} \\ Kvašáky (malé)
        \item \piece \textbf{1/2 ks} \\ Červené cibule
        \item \spoon \textbf{3 PL} \\ Majolky
        \item \liquid \textbf{trochu} \\ Citronové šťávy
    \end{ingredients}
    \begin{steps}
        \item Celer a jablko nastrouháme najemno.
        \item Přidáme nadrobno nakrájenou cibuli, okurky a pažitku (šnitlík).
        \item Zakápneme citronem, opepříme a spojíme majolkou.
    \end{steps}
\end{recipe}

\begin{recipe}[Peru]{Budapešťská pomazánka}
    \begin{ingredients}
        \item \piece \textbf{2 ks} \\ Tvarohy (v kostce)
        \item \weight \textbf{125 g} \\ Másla
        \item \spoon \textbf{2 PL} \\ Sladké papriky
        \item \piece \textbf{1 ks} \\ Cibule
        \item \piece \textbf{1 ks} \\ Kapie (čerstvá nebo naložená)
    \end{ingredients}
    \begin{steps}
        \item Máslo vyšleháme s paprikou, přidáme tvaroh a znovu prošleháme.
        \item Pokud je směs moc tuhá, zředíme troškou mléka nebo smetany.
        \item Vmícháme nadrobno nakrájenou cibuli a kapii.
    \end{steps}
\end{recipe}

\begin{recipe}[RoyalPurple]{Hermelínová pomazánka}
    \begin{ingredients}
        \item \piece \textbf{2 ks} \\ Hermelínu
        \item \weight \textbf{100 g} \\ Šunky
        \item \piece \textbf{2 ks} \\ Vejce (uvařená natvrdo)
        \item \piece \textbf{1 ks} \\ Malá cibule
        \item \spoon \textbf{3 PL} \\ Majolky nebo zakysané smetany
    \end{ingredients}
    \begin{steps}
        \item Hermelín, šunku i vejce nastrouháme na hrubém struhadle.
        \item Přidáme jemně nasekanou cibuli a spojíme majolkou.
        \item Necháme v lednici aspoň hodinu odležet.
    \end{steps}
\end{recipe}

\begin{recipe}[Chocolate]{Domácí paštika}
    \begin{ingredients}
        \item \weight \textbf{500 g} \\ Drůbežích jater
        \item \weight \textbf{250 g} \\ Másla
        \item \piece \textbf{1 ks} \\ Cibule
        \item \liquid \textbf{1 dcl} \\ Smetany ke šlehání
        \item \indefinite \textbf{dle chuti} \\ Tymián, sůl, pepř, koňak
    \end{ingredients}
    \begin{steps}
        \item Cibuli zpěníme na kousku másla, přidáme očištěná játra a tymián. Restujeme doměkka.
        \item Osolíme a opepříme až po tepelné úpravě!
        \item Směs rozmixujeme dohladka se zbytkem másla a smetanou.
        \item Pro luxusnější chuť přidáme lžíci koňaku. Plníme do skleniček a zalijeme rozpuštěným máslem.
    \end{steps}
\end{recipe}

\begin{recipe}[Goldenrod]{Vaječná pomazánka}
    \begin{ingredients}
        \item \piece \textbf{6 ks} \\ Vejce (natvrdo)
        \item \weight \textbf{100 g} \\ Změklého másla
        \item \spoon \textbf{1 PL} \\ Plnotučné hořčice
        \item \piece \textbf{1 ks} \\ Jarní cibulka
    \end{ingredients}
    \begin{steps}
        \item Žloutky utřeme s máslem a hořčicí do hladkého krému.
        \item Bílky nastrouháme najemno a vmícháme do krému.
        \item Přidáme nasekanou jarní cibulku, sůl a pepř.
    \end{steps}
\end{recipe}

\begin{recipe}[FireBrick]{Kanafasky}
    \begin{ingredients}
        \item \weight \textbf{25 dkg} \\ Hladké mouky
        \item \weight \textbf{25 dkg} \\ Tuku (Hera nebo máslo)
        \item \piece \textbf{1 ks} \\ Vejce
        \item \spoon \textbf{1 PL} \\ Octa
        \item \indefinite \textbf{náplň} \\ Povidla nebo tuhý tvaroh
    \end{ingredients}
    \begin{steps}
        \item Zpracujeme těsto, necháme v lednici odležet.
        \item Vyválíme, krájíme čtverečky, plníme a protilehlé rohy spojíme.
        \item Pečeme na 180 °C a horké obalujeme v cukru.
    \end{steps}
\end{recipe}

\begin{recipe}[OliveGreen]{Domácí pizza (od Lukáše)}
    \begin{ingredients}
        \item \indefinite \textbf{základ} \\ Kynuté – nekynuté těsto
        \item \liquid \textbf{sugo} \\ Protlak, česnek, oregáno
        \item \indefinite \textbf{náplň} \\ Šunka, sýr, kukuřice, žampiony
    \end{ingredients}
    \begin{steps}
        \item Těsto vyválíme na tenko přímo na plech.
        \item Potřeme sugem (ochucený protlak).
        \item Poklademe surovinami dle chuti a peče na max (250 °C) cca 8–10 minut.
    \end{steps}
\end{recipe}
